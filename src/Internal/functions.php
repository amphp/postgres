 ...
 * @param-out array<int, int|string> $names Array of parameter positions mapped to names and/or indexed locations.
 *
 ...
 * @param array<int, int|string> $names Array generated by the $names param of {@see parseNamedParams()}.
 *
